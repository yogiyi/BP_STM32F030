...
#define _02FF_TAU_TDR00_VALUE                   (0x02FFU)
/* 16-bit timer data register 01 (TDR01) */
#define _0180_TAU_TDR01_VALUE                   (0x0180U)
