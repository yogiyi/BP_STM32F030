...
In this example, one EXTI line (EXTI0) when using the STM32F0308-Discovery kit is
...
If STM32F0308-Discovery kit is used,when User-button is pressed,LED3 and LED4 toggle.

In this example, EXTI0_Config() function can be substituted by 
STM_EVAL_PBInit(BUTTON_USER, Mode_EXTI) provided in the STM32F0308-Discovery driver.
